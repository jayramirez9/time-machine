...
const EVENT_TEMPLATES = [
  // ─── Universal ────────────────────────────────────────────────
  {
    ...
    priority: 'low', avgCooldownSec: 20, gainDb: -22,
  ...
  {
    id: 'insect_chorus_day', group: 'universal',
    description: 'Daytime insect chorus — cicadas droning in the heat',
    avgCooldownSec: 40, gainDb: -24,
    spatial: { azimuth: 60, elevation: 8, distance: 0.5, spread: 50 },
    motion: { type: 'static' },
    timeOfDay: { min: 0.3, max: 0.78 },
    activityRange: [0, 0.6], sourceCount: 1,
    climate: ['temperate', 'subtropical', 'tropical'],
    // Annual cicadas sing in real heat — gate on absolute temperature, not
    // season alone (PRD §5.6: a cicada at midnight OR on a cold day is the flinch)
    temperatureGate: { minC: 24 },
  },
  {
    id: 'insect_chorus_night', group: 'universal',
    description: 'Night insect chorus — crickets and katydids',
    avgCooldownSec: 40, gainDb: -24,
    ...
    climate: ['temperate', 'subtropical', 'tropical'],
    // Crickets and katydids go quiet near freezing
    temperatureGate: { minC: 8 },
  },
  {
  ...
  // ─── Door / Window Foley ──────────────────────────────────────
  {
    id: 'door_open_close', group: 'universal',
    description: 'Door opening and closing — wood door with latch click',
    avgCooldownSec: 45, gainDb: -22,
    spatial: { azimuth: -35, elevation: 0, distance: 0.25, spread: 8 },
    motion: { type: 'static' },
  ...
  {
    id: 'door_creak', group: 'universal',
    description: 'Door creaking on old hinges — slow wooden groan',
    avgCooldownSec: 90, gainDb: -24,
    spatial: { azimuth: 40, elevation: 0, distance: 0.3, spread: 5 },
    motion: { type: 'static' },
    timeOfDay: { min: 0, max: 1 },
    activityRange: [0.1, 1], sourceCount: 1,
    minDensity: 'suburban',
  ...
  {
    id: 'window_rattle', group: 'universal',
    description: 'Window rattling in wind — loose pane vibrating in frame',
    avgCooldownSec: 60, gainDb: -24,
    spatial: { azimuth: -15, elevation: 3, distance: 0.2, spread: 5 },
    motion: { type: 'static' },
    timeOfDay: { min: 0, max: 1 },
    activityRange: [0, 1], sourceCount: 1,
    weatherGate: 'wind', // fires more often in wind — handled by scheduler
  },
  {
    id: 'shutter_bang', group: 'universal',
    description: 'Shutter banging against wall — wind-driven wooden clatter',
    avgCooldownSec: 120, gainDb: -20,
    spatial: { azimuth: 25, elevation: 2, distance: 0.3, spread: 8 },
    motion: { type: 'static' },
    timeOfDay: { min: 0, max: 1 },
    activityRange: [0, 1], sourceCount: 1,
    weatherGate: 'wind',
  ...
  {
    id: 'gate_latch', group: 'universal',
    description: 'Iron gate latch clicking — garden or fence gate',
    avgCooldownSec: 80, gainDb: -24,
    spatial: { azimuth: -50, elevation: -3, distance: 0.3, spread: 5 },
    motion: { type: 'static' },
  ...
  // ─── Material-Contact Foley ──────────────────────────────────
  {
    id: 'object_clatter', group: 'universal',
    description: 'Objects clattering — wooden crate or barrel shifted, thud and scrape',
    avgCooldownSec: 60, gainDb: -24,
    spatial: { azimuth: 55, elevation: -5, distance: 0.35, spread: 10 },
    motion: { type: 'static' },
    timeOfDay: { min: 0.28, max: 0.82 },
    activityRange: [0.4, 1], sourceCount: 1,
    minDensity: 'suburban',
  },
  {
    id: 'metal_clang', group: 'universal',
    description: 'Metal clang — iron pail, tool, or hardware dropped or struck',
    avgCooldownSec: 90, gainDb: -22,
    spatial: { azimuth: -45, elevation: -3, distance: 0.4, spread: 12 },
    motion: { type: 'static' },
    timeOfDay: { min: 0.28, max: 0.78 },
    activityRange: [0.4, 1], sourceCount: 1,
    minDensity: 'suburban',
  },
  {
    id: 'glass_clink', group: 'universal',
    description: 'Glass clinking — bottles or glasses touching, tavern or shop',
    priority: 'low', avgCooldownSec: 70, gainDb: -26,
    spatial: { azimuth: -30, elevation: 0, distance: 0.25, spread: 5 },
    motion: { type: 'static' },
    timeOfDay: { min: 0.3, max: 0.92 },
    activityRange: [0.3, 1], sourceCount: 1,
    minDensity: 'suburban',
  },
  {
    id: 'cloth_rustle', group: 'universal',
    description: 'Cloth rustling — laundry on a line, awning flapping, fabric in breeze',
    avgCooldownSec: 50, gainDb: -26,
    spatial: { azimuth: 15, elevation: 3, distance: 0.2, spread: 8 },
    motion: { type: 'static' },
  ...
  {
    id: 'broom_sweep', group: 'universal',
    description: 'Broom sweeping — bristles on stone or wood, rhythmic strokes',
    avgCooldownSec: 120, gainDb: -24,
    spatial: { azimuth: -25, elevation: -5, distance: 0.25, spread: 8 },
    motion: { type: 'static' },
    timeOfDay: { min: 0.28, max: 0.5 },
    activityRange: [0.3, 1], sourceCount: 1,
    minDensity: 'suburban',
  },
  {
    id: 'water_pour', group: 'universal',
    description: 'Water pouring or splashing — bucket emptied, trough filled, drain flow',
    avgCooldownSec: 90, gainDb: -24,
    spatial: { azimuth: 35, elevation: -5, distance: 0.3, spread: 8 },
    motion: { type: 'static' },
    timeOfDay: { min: 0.25, max: 0.82 },
    activityRange: [0.2, 1], sourceCount: 1,
  },
  {
    id: 'keys_jingle', group: 'universal',
    description: 'Keys jingling — metal keyring, locking or unlocking a door',
    priority: 'low', avgCooldownSec: 80, gainDb: -26,
    spatial: { azimuth: -35, elevation: 0, distance: 0.2, spread: 3 },
    motion: { type: 'static' },
  ...
  // ─── Pre-1830 ─────────────────────────────────────────────────
  {
    ...
    // Inherited into later eras (horses persist to ~1920), so the surface must
    // track the scene era — a hardcoded 'dirt' gave 1884 cobblestone scenes
    // the wrong foley variant.
    surfaceFromEra: true,
  ...
  {
    id: 'elevated_train', group: 'steam_age',
    description: 'Elevated railway — steam locomotive on iron trestle, rhythmic clatter overhead',
    avgCooldownSec: 90, gainDb: -12,
    spatial: { azimuth: 0, elevation: 25, distance: 0.6, spread: 40 },
    motion: { type: 'passby', azimuthStart: -90, azimuthEnd: 90, durationSec: 12, dopplerFactor: 0.3 },
    timeOfDay: { min: 0.22, max: 0.95 },
    activityRange: [0.2, 1], sourceCount: 1,
    minDensity: 'urban',
  },
  {
    id: 'bicycle_bell', group: 'steam_age',
    description: 'Bicycle bell — single clear ring, rider passing',
    avgCooldownSec: 60, gainDb: -24,
    spatial: { azimuth: 70, elevation: -5, distance: 0.3, spread: 8 },
    motion: { type: 'passby', azimuthStart: -30, azimuthEnd: 30, durationSec: 4, dopplerFactor: 0.1 },
    timeOfDay: { min: 0.25, max: 0.85 },
    activityRange: [0.3, 1], sourceCount: 1,
    minDensity: 'suburban',
  },
  ...
  {
    id: 'bus_diesel', group: 'auto_age',
    description: 'Diesel bus — engine roar, air brakes hissing, pulling away from stop',
    avgCooldownSec: 45, gainDb: -14,
    spatial: { azimuth: 90, elevation: -3, distance: 0.5, spread: 25 },
    motion: { type: 'passby', azimuthStart: -45, azimuthEnd: 60, durationSec: 8, dopplerFactor: 0.25 },
    surface: 'asphalt',
    timeOfDay: { min: 0.22, max: 0.95 },
    activityRange: [0.2, 1], sourceCount: 1,
    minDensity: 'urban',
  ...
  {
    id: 'subway_rumble', group: 'auto_age',
    description: 'Subway rumble underfoot — distant train vibration through grating',
    avgCooldownSec: 60, gainDb: -22,
    spatial: { azimuth: 0, elevation: -15, distance: 0.5, spread: 50 },
    motion: { type: 'static' },
    timeOfDay: { min: 0.2, max: 0.98 },
    activityRange: [0.1, 1], sourceCount: 1,
    minDensity: 'dense_urban',
  },
...
function selectTemplates(eraBracket, density, climate) {
  ...
  return EVENT_TEMPLATES
    ...
    .map(t => {
      ...
      // Resolve surface from era metadata (footsteps, horse traffic)
      if (t.surfaceFromEra) {
        const meta = ERA_META[eraBracket];
        if (t.id === 'horse_walk') {
          mapped.surface = meta.surface;
          const surfaceLabel = (meta.surface || 'ground').replace(/_/g, ' ');
          mapped.description = meta.surface === 'dirt'
            ? 'Horse walking on unpaved road — hooves on packed earth'
            : `Horse walking on ${surfaceLabel} — hooves clopping`;
        } else {
...
// Layer profile for directional beds — near/mid/far perspectives layered
// simultaneously per direction produce spatial depth from one location.
// gainOffsetDb is summed with the direction's baseGainDb at runtime.
const DIRECTIONAL_LAYERS = [
  {
    ...
    spreadMul: 0.7,
    gainOffsetDb: 2,
    variantHint: 'close perspective — individual sounds clearly resolved, immediate detail',
  },
  {
    suffix: 'mid',
    distance: null,
    spreadMul: 1.0,
    gainOffsetDb: 0,
    variantHint: 'mid distance — blended activity, moderate ambience and presence',
  },
  {
    suffix: 'far',
    distance: 0.9,
    spreadMul: 1.4,
    gainOffsetDb: -3,
    variantHint: 'far perspective — distant rumble and reverberant tail, low-frequency emphasis',
  },
];

/**
 * Build 3 layered sources (near/mid/far) for a directional bed.
 * Each layer plays simultaneously at runtime; ElevenLabs generates a
 * distinct take per layer via variantHint.
 */
function layeredDirectionalSources(labelBase, spatial) {
  return DIRECTIONAL_LAYERS.map(layer => {
    const layerSpatial = spatial
      ? {
          ...spatial,
          distance: layer.distance ?? spatial.distance,
          spread: Math.round((spatial.spread ?? 60) * layer.spreadMul),
        }
      : null;
    const src = nullSource(`${labelBase}-${layer.suffix}`, layerSpatial);
    src.variantHint = layer.variantHint;
    src.gainOffsetDb = layer.gainOffsetDb;
    return src;
  });
}
...
/**
 * Era-appropriate phrases for street vendor types.
 * Each vendor maps to 2-3 cries/calls typical of the era.
 */
const VENDOR_PHRASES = {
  newsboy:         ['Extra! Extra! Read all about it!', 'Paper! Get your morning paper!', 'Latest news, one cent!'],
  'hot corn girl':  ['Hot corn! Hot corn! Here\'s your nice hot corn!', 'Piping hot, come get your corn!'],
  'oyster seller':  ['Oysters! Fine fresh oysters!', 'Here\'s your fine oysters!'],
  'milk man':       ['Fresh milk! Morning delivery!', 'Milk here! Fresh from the dairy!'],
  'knife grinder':  ['Knives to grind! Scissors to sharpen!', 'Grinder! Bring your knives!'],
  'pushcart vendor':['Fresh fruit! Apples, oranges!', 'Vegetables! Fresh vegetables today!'],
  'pretzel seller': ['Hot pretzels! Fresh pretzels!', 'Pretzels! Get \'em hot!'],
  'flower girl':    ['Fresh flowers! Lovely bouquets!', 'Roses! Violets! Beautiful flowers!'],
  'hot dog vendor': ['Hot dogs! Get your hot dogs!', 'Red hots! Fresh off the grill!'],
  'ice cream vendor':['Ice cream! Cold ice cream!', 'Vanilla, chocolate, strawberry!'],
  'boot black':     ['Shine your shoes, sir?', 'Bootblack! Best shine in town!'],
  'shoe shine':     ['Shoe shine! Best shine in town!', 'Shine, mister?'],
  'ice man':        ['Ice! Ice delivery!', 'Block ice! Keep it cold!'],
  'rag picker':     ['Rags! Old rags and bones!', 'Any old rags today?'],
  peddler:          ['Pots and pans! Tinware!', 'Wares for sale! Come and see!'],
  'chimney sweep':  ['Sweep! Chimney sweep!', 'Clean your chimney, sir?'],
  'water carrier':  ['Fresh water! Clean water!', 'Water here!'],
};

/**
 * Generate voice micro-events for urban profiles.
 * For 1850-1960 urban: vendor cries from cultural data.
 * For modern urban: ambient speech fragments.
 */
function generateVoiceEvents(year, density, locationData) {
  const dIdx = densityIdx(density);
  if (dIdx < densityIdx('urban')) return []; // suburban/rural: no street voices

  const events = [];

  if (year >= 1850 && year <= 1960) {
    // Street vendor era — use cultural data when available, else generic
    const vendors = locationData?.vendors || ['pushcart vendor', 'newsboy'];
    const selected = vendors.slice(0, 3); // Max 3 voice events

    for (const vendor of selected) {
      const vendorKey = vendor.toLowerCase();
      const phrases = VENDOR_PHRASES[vendorKey] || [`${vendor}! Come see!`, `${vendor} here!`];
      events.push({
        id: `voice_${vendorKey.replace(/\s+/g, '_')}`,
        description: `Street vendor — ${vendor} calling out to passersby`,
        voice: vendorKey.replace(/\s+/g, '_'),
        phrases,
        sources: [
          nullSource(`voice_${vendorKey.replace(/\s+/g, '_')}-1`),
          nullSource(`voice_${vendorKey.replace(/\s+/g, '_')}-2`),
        ],
        avgCooldownSec: 60,
        gainDb: -18,
        spatial: { azimuth: 40 + events.length * 30, elevation: -3, distance: 0.35, spread: 15 },
        motion: { type: 'static' },
        timeOfDay: { min: 0.3, max: 0.75 },
        activityRange: [0.4, 1],
      });
    }
  } else if (year > 1960) {
    // Modern era — casual speech/conversation fragments
    events.push({
      id: 'voice_passerby',
      description: 'Nearby conversation fragment — indistinct speech, casual tone',
      sources: [nullSource('voice_passerby-1'), nullSource('voice_passerby-2')],
      avgCooldownSec: 45,
      gainDb: -22,
      spatial: { azimuth: 30, elevation: -3, distance: 0.25, spread: 12 },
      motion: { type: 'passby', azimuthStart: -20, azimuthEnd: 20, durationSec: 5, dopplerFactor: 0.03 },
      timeOfDay: { min: 0.28, max: 0.9 },
      activityRange: [0.4, 1],
    });
  }
...
export function generateProfile({ location, year, month = null, population = 0, countryCode, lat, lon, environmentProfile }) {
  ...
  // Variant hints for multi-source events — each take gets a distinct prompt modifier
  const VARIANT_HINTS = [
    'slightly closer, more present',
    'slightly farther, more reverberant',
    'different timing and rhythm',
    'higher register, brighter tone',
    'lower register, warmer tone',
  ];

  const microEvents = Array.from(templates, t => {
    const sources = [];
    for (let i = 0; i < (t.sourceCount || 1); i++) {
      const src = nullSource(`${t.id}-${i + 1}`);
      if ((t.sourceCount || 1) > 1) {
        src.variantHint = VARIANT_HINTS[i % VARIANT_HINTS.length];
      }
      sources.push(src);
    }
    const event = {
    ...
    if (t.weatherGate) event.weatherGate = t.weatherGate;
    if (t.temperatureGate) event.temperatureGate = { ...t.temperatureGate };
    if (t.suppressed) event.suppressed = true;
    if (t.priority) event.priority = t.priority;
    return event;
  });
  ...
  const profile = {
    ...
    beds: {
      ...
      directional: {
        N: {
          sources: layeredDirectionalSources('dir-north', { azimuth: 0, elevation: -5, distance: 0.6, spread: 40 }),
          gainDb: -16 + (DENSITY_GAIN_OFFSET[density] || 0),
          description: dirDescs.N,
        },
        E: {
          sources: layeredDirectionalSources('dir-east', { azimuth: 90, elevation: -5, distance: 0.4, spread: 60 }),
          gainDb: -10 + (DENSITY_GAIN_OFFSET[density] || 0),
          description: dirDescs.E,
        },
        S: {
          sources: layeredDirectionalSources('dir-south', { azimuth: 180, elevation: -5, distance: 0.5, spread: 50 }),
          gainDb: -14 + (DENSITY_GAIN_OFFSET[density] || 0),
          description: dirDescs.S,
        },
        W: {
          sources: layeredDirectionalSources('dir-west', { azimuth: -90, elevation: -5, distance: 0.5, spread: 30 }),
  ...
  // Auto-generate voice configs for urban profiles
  const voiceEvents = generateVoiceEvents(year, density, locationData);
  if (voiceEvents.length > 0) {
    for (const ve of voiceEvents) {
      profile.microEvents.push(ve);
    }
  }
...
function extractLocationData(profile, density) {
  ...
  if (ecology?.species) {
    ...
    // sonorous: false = species that make no chorus sound (fireflies) —
    // they exist in ecology but must never be named in an SFX prompt
    const insects = ecology.species.filter(s => s.type === 'insect' && s.sonorous !== false);
    if (insects.length) {
      // Split by diurnal dominance so day and night choruses draw from the
      // right species — averaging cicadas with katydids is the midnight-cicada flinch
      result.hasInsectSplit = true;
      // Ties go to day: a species equally active both sides belongs in the
      // gated-day bed, where the temperature gate still bounds it
      const dayInsects = insects.filter(s => (s.diurnal?.day ?? 0) >= (s.diurnal?.night ?? 0));
      const nightInsects = insects.filter(s => (s.diurnal?.night ?? 0) > (s.diurnal?.day ?? 0));
      if (dayInsects.length) {
        result.insectDayNames = dayInsects.map(i => i.commonName);
        result.insectDayDiurnal = aggregateWeights(dayInsects, 'diurnal');
        result.insectDaySeasonal = aggregateWeights(dayInsects, 'seasonal');
      }
      if (nightInsects.length) {
        result.insectNightNames = nightInsects.map(i => i.commonName);
        result.insectNightDiurnal = aggregateWeights(nightInsects, 'diurnal');
        result.insectNightSeasonal = aggregateWeights(nightInsects, 'seasonal');
      }
    }
  }
...
function enrichTemplates(templates, locationData, opts = {}) {
  ...
  for (const t of templates) {
    switch (t.id) {
      ...
      case 'insect_chorus_day':
        if (locationData.hasInsectSplit && !locationData.insectDayNames) {
          // ecology is authoritative: nothing here sings by day. A cooldown is
          // NOT suppression (the pool still rolls) — the flag is what the
          // scheduler and asset fetcher skip on.
          t.suppressed = true;
          break;
        }
        applyEcologyWeights(t, {
          names: locationData.insectDayNames,
          diurnal: locationData.insectDayDiurnal,
          seasonal: locationData.insectDaySeasonal,
          descPrefix: 'Daytime insect chorus',
          nameJoin: names => names.join(' and ')
        }, season);
        break;

      case 'insect_chorus_night':
        if (locationData.hasInsectSplit && !locationData.insectNightNames) {
          t.suppressed = true;
          break;
        }
        applyEcologyWeights(t, {
          names: locationData.insectNightNames,
          diurnal: locationData.insectNightDiurnal,
          seasonal: locationData.insectNightSeasonal,
          descPrefix: 'Night insect chorus',
          nameJoin: names => names.join(' and ')
        }, season);
        break;
