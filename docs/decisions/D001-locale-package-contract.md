...
- **2026-08-05 — D002.** The Baton Rouge conformance locale is `baton-rouge-1985`, not `-1978`: the port is the witness scene, and the anchor photo picks the date. See `D002-baton-rouge-1985-witness-scene.md`. The consequences list above reflects the pre-D002 naming.
